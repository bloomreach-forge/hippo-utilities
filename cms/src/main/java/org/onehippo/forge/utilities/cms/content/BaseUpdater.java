...
package org.onehippo.forge.utilities.cms.content;
...
public abstract class BaseUpdater implements UpdaterModule {
     ...
     * @param context the {@link UpdaterContext} on which the start and end tag will be set.
     */
    protected abstract void registerTags(UpdaterContext context);

    /**
     * Remove a sub node
     * @param node the parent {@link Node} from which the childNode should be removed
     * @param name the name of the child {@link Node}
     * @throws RepositoryException In case the child node could not be removed
     */
    ...
    /**
     * Remove a {@link Property} by name from the given {@link Node}.
     * @param node the from which the property should be removed
     * @param property name of the property which should be removed
     * @throws RepositoryException In case the property could not be removed
     */
    ...
    /**
     * Gets the {@link String} value of the given {@link Property} from the {@link Node}. This method will not work for
     * property of type binary or date.
     * @param node the {@link Node}
     * @param property the name of the property
     * @return the String representation of the given property
     * @throws RepositoryException In case the value of the property could not be retrieved.
     */
    ...
    /**
     * Gets the UUID of the given {@link Node}
     * <p/>
     ...
     * @throws RepositoryException In case something goes wrong while trying to get the UUID
     */
     ...
     * @return the {@link Node} containing the HST page
     * @throws RepositoryException In case something goes wrong while getting or creating the node
     */
     ...
     * @param node the parent {@link Node} to which to add the <code>hst:template</code> node or from which to get the
     * existing template
     ...
     * @return the {@link Node} containing the hst template configuration
     * @throws RepositoryException In case the an exception occurs while trying to get/create the template node or according
     * properties.
     */
     ...
     * @param node the parent {@link Node} to which to add the <code>hst:component</code> or from which to get the
     ...
     * @return the {@link Node} containing the hst component configuration
     * @throws RepositoryException In case an exception occurs while trying to get/create the component node or according
     * properties.
     */
     ...
     * @param node the parent {@link Node} to which to add the <code>hst:sitemap</code> or from which to get the
     ...
     * will be set for this HST sitemap item.
     * @return the {@link Node} containing the hst sitemap item configuration
     * @throws RepositoryException In case an exception occurs while trying to get/create the sitemap node or according
     * properties.
     */
     ...
     * @param node the parent {@link Node} from which to get the sitemenu, or to which to add a sitemenu.
     ...
     * @return the {@link Node} containing the hst sitemenu configuration
     * @throws RepositoryException In case an exception occurs while trying to get/create the sitemenu node.
     */
     ...
     * @param node the parent {@link Node} from which to get the sitemenu item, or to which to add a sitemenu item.
     ...
     * @return the {@link Node} containing the hst sitemenu item configuration
     * @throws RepositoryException In case an exception occurs while trying to get/create the sitemenu item node
     */
     ...
     * @param node {@link Node} the node to which to add the properties
     * @param parameterNames the names of parameters
     * @param parameterValues the values of parameters
     * @throws RepositoryException In case an exception occurs while trying to set properties
     */
     ...
     * @param propertiesDoc the {@link Node} representing the properties document
     * @param propName the name of the property
     * @param propValue the value of the property
     * @throws RepositoryException In case an exception occurs while trying to set/modify the property
     */
     ...
     * @param propertiesDoc a properties {@link Node}
     * @param propName the name of the property
     * @throws RepositoryException In case an exception occurs while trying to remove the property
     */
    ...
    /**
     * Get a {@link Node} of type <i>hippostd:folder</i> based on it's parent {@link Node} and the folder name.
     * @param node the parent Node of the folder
     * @param folderName the name of the folder Node
     * @return a {@link Node} with the given name of type <i>hippostd:folder</i> or <code>null</code> otherwise.
     * @throws RepositoryException In case something goes wrong while trying to get the folder
     */
    ...
    /**
     * Create a Node of type <i>hippostd:folder</i> underneath the given {@link Node}. With the creation of this folder,
     ...
     * @throws RepositoryException In case something goes wrong while trying to add the folder
     */
    ...
    /**
     * Create a Node of type <i>hippostd:folder</i> underneath the given {@link Node}
     * @param node the Node underneath which the folder should be created
     * @param folderName the name of the folder
     * @param folderTypes the allowed types, which can be added to this folder
     * @return the Node with the new folder attached
     * @throws RepositoryException In case something goes wrong while trying to create the folder
     */
